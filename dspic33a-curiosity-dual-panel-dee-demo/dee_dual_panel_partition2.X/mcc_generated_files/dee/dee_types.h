...
#define DATA_EE_BANKS                     4
#define DATA_EE_SIZE                      128
...
#define DEE_ADDRESS_MASK                  0x000000FF
#define WRITE_RETRY_COUNT                 2
#define ADDRESS_INC_FACTOR                16U
#define ADDRESS_PER_INSTRUCTION           4
#define FLASH_WORD_WRITE_SIZE             4
#define DEE_START_ADDRESS_INACTIVE_PARTITION 0xC38000
#define DEE_START_ADDRESS_ACTIVE_PARTITION   0x838000
#define BYTES_PER_DATA_EE                 4
