...
## dsPIC33A Curiosity Dual Panel Data EEPROM Emulation Demo
...
- dsPIC33AK512MPS512 GP DIM (https://www.microchip.com/ev80l65a)
- USB Type-c Cable
...
## Operation
This demo first runs the Data EEPROM Emulation on the active partition , if emulation is successful then prints the message as shown below

![image](../images/success.jpg)

After that execution switch is done and application i.e. Data EEPROM emulation code on the new active partition runs , prints the message as below
![image](../images/dee_dual_partition.jpg)
...
![image](../images/dee_dual_partition_failure.jpg)
